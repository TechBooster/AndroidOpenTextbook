...
実際にアプリケーションを作るときにも避けては通れない道です。ただ、そのわりには体系的に教えることがむずかしい分野でもあります（経験値も必要なため）。

興味のある方は、ぜひ書店などで専門書を読んでみることをおすすめします。きっと、世の中に対する物事の見方が変わります（笑）。
とはいえ、そこまでしなくても、普段みなさんが使っているアプリケーション（パソコンでもスマートフォンでもかまいません）で、どこにアフォーダンスが使われているかを考えるだけでも、よいインターフェースの勉強になりますのでぜひ実践してみてください。
...
//footenote[reject][アプリが公開されずに戻ってきてしまうこと。リジェクトされると、審査時にNGだったところを修正して、再度申請しなければならない]
...
//footnote[akaban][これを「アカBAN」といい、開発者が最も恐れていることです]
