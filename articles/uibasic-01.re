...
また、クリック時（押されたとき）には凹んだように見せることによって、ユーザーに「ボタンを押した」ことを認識させています。
...
少し前まではそれだけでよかったのですが、2007年にiPhoneが発売されてから、デザイナーの業界もガラッと様子が変わりました。
...
このような制約の中でインターフェースをつくることは、多くの試行錯誤を必要としました。
...
もし、内容がよくわからなくても、ここにある図だけでも見ておくとよいでしょう。これらはすべてガイドラインに沿ったAndroidアプリのデザインになっていますので、実際に設計するときに役に立ちます。
...
//image[comp-twitter][Twitter（左：Android、中央：Androidのメニュー、右：iOS）]{
//}
