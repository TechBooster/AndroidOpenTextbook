...
その場合、レスポンス内のContentは、何らかのフォーマットで圧縮したほうが良いでしょう。
...
//footnote[curl_is_really_useful][本当はAndroidアプリで取ってきた例を上げたほうがAndroidの教科書らしいんですけど、本章では時間の都合もあって省略します。いろいろ試す場合にそのたびにActivityを作ってアプリを起動して、とやるより、単にcurl一行でデータ取ってきて、状況に応じてPOSTリクエスト等を送るほうが、Webサービスの様子を調べるほうが効率は良いような気がします。]
...
コンピュータの基本に帰れば、バイナリを送る方法が効率は良いのです。
