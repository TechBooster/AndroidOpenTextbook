...
//footnote[learning_nfc][本章筆者は新RFCの記述方法の的確さに感動してしまい、本来本章で記述するべきAndroidに関わる内容よりも圧倒的に多くの時間を単なるHTTP 1.1の仕様理解とRFC読みに費やしてしまいました。「いいじゃんAndroidアプリでそこが問題になることはほとんどないよ」という事実には意識が向きませんでした。]
