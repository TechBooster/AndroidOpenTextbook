...
HTTPのリクエストやレスポンスに、「終端記号」に該当するものがないことに
気づいた方もいるかもしれません。
終端器号がないかわりに、Content-Lengthという別のヘッダフィールドで、
文字列の長さを送信することで終端を明示できます。

ヘッダにContent-Lengthを入れるのが難しい場合があります。
